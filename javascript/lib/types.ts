...
export type FmRoot = "DcsSavedGames" | "AerosimicsAtcAbm";
...
export type MoveFileRequest = { root: FmRoot; source: string; destination: string };
...
export type ResourceKind = "system" | "game_server" | "agent" | "mod";

export type ResourceUsage = {
  id: string;
  name: string;
  kind: ResourceKind;
  cpu_percent: PrometheusSeries | null;
  memory_bytes: PrometheusSeries | null;
};
